...
var MeasurementExecutor = function () {
  ...
  _createClass(MeasurementExecutor, [{
    ...
    value: function timerElapsed(measureable) {
      if (typeof this.strategy.technique_preference === 'function' && this.strategy.technique_preference(this.measureables)) {
...
var defaultStrategy = exports.defaultStrategy = function defaultStrategy() {
  return {
    autostart: true,
    technique_preference: _rules.VIEWABLE_RULES.ANY,
    unmeasureable_rule: _rules.UNMEASUREABLE_RULES.ALL,
...
var TECHNIQUE_PREFERENCE = exports.TECHNIQUE_PREFERENCE = {
  ...
  ANY_UNMEASUREABLE: function ANY_UNMEASUREABLE(measureables) {
    return measureables.reduce(function (unmeasureable, m) {
